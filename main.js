...
function clickNueva() {
    ...
    if(orientacion%360!=0) {

        persona1.innerHTML = persona2.innerHTML;
        objeto1.innerHTML = objeto2.innerHTML;
        accion1.innerHTML = accion2.innerHTML;
        dificil1.innerHTML = dificil2.innerHTML;
        todos1.innerHTML = todos2.innerHTML;
    }
    ...
    baraja__tarjeta.style.transform = '';
    
    
    setTimeout(()=>{


    baraja__tarjeta.style.transitionDuration = '0.3s';
    baraja__tarjeta.classList.add('tarjeta-derecha');        
    },5);

    setTimeout(()=>{

        baraja__tarjeta.style.transitionDuration = '0s';
        baraja__tarjeta.classList.remove('tarjeta-derecha');
        baraja__tarjeta.classList.add('tarjeta-izquierda');                
    ...
    setTimeout(()=>{
        baraja__tarjeta.style.transitionDuration = '0.3s';
        baraja__tarjeta.classList.remove('tarjeta-izquierda');
    },605);
